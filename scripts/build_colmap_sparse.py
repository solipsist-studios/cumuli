...
def main():
    ...
    points_source = args.points_ply or args.seed_splat_ply
    if not points_source.is_file():
        print(f"Error: {points_source} not found")
        sys.exit(1)
    ...
    try:
        ...
        print(f"Error: {points_source} could not be read as a point cloud: {e}")
        sys.exit(1)
