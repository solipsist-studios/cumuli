...
Cycles applies no radial distortion to a perspective camera; the
coefficients are kept for provenance and the pipeline skips undistortion.
...
| `scripts/blender_render_rig.py` | The render loop, inside Blender |
