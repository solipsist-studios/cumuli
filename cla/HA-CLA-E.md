...
> HA-CLA-E v1.0 template with this project's selections filled in. It has
> not yet been reviewed by counsel and is not yet being collected. See
> [CONTRIBUTING.md](../CONTRIBUTING.md).
>
> Selections made from the template, all of which counsel should confirm:
> **Section 2.3 = Option Five** (permits commercial and proprietary
> licensing, conditioned on also licensing under the project's public
> license); jurisdiction = Quebec, Canada; media licensed under the same
> terms as the Material; the optional "or Your Affiliates" wording in
> Section 2.2 is retained.
>
> **Use this version if you are contributing on behalf of a company** — for
> example if your employment contract assigns your work to your employer.
> Individuals contributing on their own behalf should use
> [HA-CLA-I.md](HA-CLA-I.md).

Thank you for your interest in contributing to the
**volumetric-capture-pipeline** project, maintained by **Solipsist Studios
Inc.** ("We" or "Us").
...
instructions at **[CONTRIBUTING.md, "Signing the CLA"](../CONTRIBUTING.md#signing-the-cla)**.
...
instructions in **[CONTRIBUTING.md, "If you do not own the whole
contribution"](../CONTRIBUTING.md#if-you-do-not-own-the-whole-contribution)**.
...
Contribution: the PolyForm Noncommercial License 1.0.0 (including any right
...
(d) You have followed the instructions in **[CONTRIBUTING.md, "If you do
not own the whole
contribution"](../CONTRIBUTING.md#if-you-do-not-own-the-whole-contribution)**,
...
laws of **Quebec, Canada** excluding its conflicts of law provisions. Under
...
GitHub organization / usernames covered: ________________________
```
...
Name:      ________________________
Title:     ________________________
Address:   Solipsist Studios Inc.
           4550 Av. de l'Esplanade, Montréal, QC H2T 2Y5, Canada
Date:      ________________________
```

---

Adapted from the Harmony Entity Contributor License Agreement (HA-CLA-E),
Version 1.0, July 4 2011, available at
<https://www.harmonyagreements.org/docs/ha-cla-e-v1.pdf>. That work is
